    ...
    <div class="grid-rows-1 gap-3">
        <div>
            <button v-on:click="socialAuth('google')"
                ...
                <img class="w-12 h-12" src="/storage/social/btn_google_light_normal_ios.svg" alt="google_logo">
        ...
        <div>
            <button v-on:click="socialAuth('twitch')"
                    class="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                <img class="w-12 h-12" src="/storage/social/TwitchExtrudedWordmarkPurple.svg" alt="twitch_logo">
